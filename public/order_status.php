...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Verwerk de bewerking van de bestelstatus
...
<div class="container mt-5">
    <h1 class="mb-4">Bestellingen Overzicht en Status Bijwerken</h1>

    <?php if ($status_updated): ?>
        <div class="alert alert-success" role="alert">
            Bestelstatus is succesvol bijgewerkt.
        </div>
    <?php endif; ?>

    <h2>Bestelstatus Bijwerken</h2>
    <form action="order_status.php" method="post">
        <div class="mb-3">
            <label for="purchase_id" class="form-label">Bestelling ID</label>
            <input type="number" class="form-control" id="purchase_id" name="purchase_id" required>
        </div>
        <div class="mb-3">
