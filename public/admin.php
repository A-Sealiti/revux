...
global $pdo;
$query = $pdo->prepare('SELECT * FROM scooter_brands');
$query->execute();
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="bg-light p-5 rounded shadow-sm text-center"><h1 class="mb-4">Welkom bij de admin omgeving</h1>
            </div>
        </div>
    </div>
    <div class="container mt-5">
        <h1 class="mb-4">Scooters Beheren </h1>
        <a href="admin_insert.php" class="btn btn-success">Insert Nieuw Scooter</a>
        <a href="categorie.php" class="btn btn-success">categorie toevogen</a>
        <a href="delete_order.php" class="btn btn-success">bestelling verwijderen </a>
        <a href="dashboard_admin/dashboard.php" class="btn btn-success">Admin dashboard </a>
            ...
            <table class="table table-striped">
                ...
                <?php foreach ($scooters as $scooter): ?>
                    <tr>
                        ...
                        <td><?= ($scooter['kleur']) ?></td>
                        <td>
                            <img src="img/<?= ($scooter['afbeelding']) ?>" alt="<?= ($scooter['naam']) ?>"
                                 style="width: 100px; height: auto;">
                        </td>
                        <td><?= ($scooter['beschrijving']) ?></td>
                        <td><?= ($scooter['prijs']) ?></td>
                        <td><?= ($scooter['merk_id']) ?></td>
                        <td class="text-center"><a href="admin_detail.php?id=<?= ($scooter['id']) ?>"
                                                   class="btn btn-info btn-sm">Details</a></td>
                        <td class="text-center"><a href="admin_update.php?id=<?= ($scooter['id']) ?>"
                                                   class="btn btn-warning btn-sm">Update</a></td>
                        <td class="text-center">
                            <a href="admin_delete.php?id=<?= ($scooter['id']) ?>" class="btn btn-danger btn-sm"
                               onclick="return confirm('Weet je zeker dat je deze scooter wilt verwijderen?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
