...
//$db = dbConnect();
$filterStars = isset($_GET['filter']) ? intval($_GET['filter']) : null;

// Haal reviews op met eventueel een filter
$reviews = getReviews($filterStars);


// Controleer
//if ($_SERVER["REQUEST_METHOD"] == "POST") {
//    echo "<pre>";
//    print_r($_POST); // Druk de inhoud v
//    echo "</pre>";
//}
?>
                ...
                <div class="collapse navbar-collapse" id="navbarNav1">
                        ...
                        <li class="nav-item bestel-vandaag mx-5">
                            <a class="nav-link" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                                    <path d="M10 .5C4.8.5.5 4.8.5 10s4.3 9.5 9.5 9.5 9.5-4.3 9.5-9.5S15.2.5 10 .5zM10 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8z" fill="#fff"></path>
                                    <path d="M10.8 9.7V6.9c0-.4-.3-.8-.8-.8s-.8.4-.8.8V10c0 .1 0 .2.1.3 0 .1.1.2.2.2l3.9 3.9c.1.1.3.2.5.2s.4-.1.5-.2c.3-.3.3-.8 0-1.1l-3.6-3.6z" fill="#fff"></path>
                                </svg>
                    ...
                    <a href="#" class="btn btn-light ms-auto me-2 mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14.1 16.4">
                            <path fill="#3ebdae" d="M1.9 12.2c-2-4.8-1.2-9.3-.5-11 4-.8 9.3 3.7 11.5 6l-.5 7c-2.7 1.3-8.5 2.8-10.5-2z" opacity=".5"></path>
            ...
            <div class="col-lg-8 d-flex align-items-center justify-content-between">
                ...
                <div class="container">
                    <form class="row g-2 d-flex align-items-center">
                        <div class="col-auto">
                            <input class="form-control" type="search" placeholder="Zoeken..." aria-label="Zoeken" style="width: 100%;">
                        </div>
                        <div class="col-auto">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle no-caret" href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<div class="container mt-5">
    <h2 class="text-center">Laat een review achter</h2>
    <form action="review.php" method="POST">
        <input type="hidden" name="scooter_id" value="<?php echo $scooterId; ?>">
        ...
        <div class="mb-3">
            <label for="sterren" class="form-label">Sterbeoordeling</label>
            <div class="rating fs-3 pointer" style=" cursor: pointer">
            ...
            <input type="hidden" name="sterren" id="sterren" required>
        </div>
        <div class="mb-3">
            <label for="review_tekst" class="form-label">Review:</label>
            <textarea class="form-control" id="review_tekst" name="review_tekst" rows="4" required></textarea>
        </div>

        <button type="submit" name="submit" class="btn btn-success">Indienen</button>
    </form>
</div>
