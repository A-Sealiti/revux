...
<div class="container mt-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><strong>Beschrijving </strong> <br><?= ($scooter['beschrijving']) ?></p>
            ...
            <?php endif; ?>
            <div class="mt-3">
                <a href="admin.php" class="btn btn-primary">Terug naar overzicht</a>
            </div>
        </div>
    </div>
</div>
