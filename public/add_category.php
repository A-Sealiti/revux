...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($naam)) {
        $query = $pdo->prepare("INSERT INTO merk (naam) VALUES (:naam)");
        ...
        if ($query->execute()) {
            ...
            $_SESSION['message'] = 'Er is een fout opgetreden bij het toevoegen van de categorie.';
        }
    } else {
        $_SESSION['message'] = 'De naam van de categorie mag niet leeg zijn.';
    }
}
?>
...
<div class="container mt-5">
    <h1 class="mb-4 text-center">Insert Nieuw Categorie</h1>
    ...
    <form action="add_category.php" method="post">
        ...
        <a href="categorie.php" class="btn btn-secondary">Annuleren</a>
    </form>
</div>
