...
$sql = "SELECT * FROM scooter_brands";
$sth = $pdo->prepare($sql);
$sth->execute();
...
<div class="container-fluid mt-5">
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <h1 class="mb-4 bg-light p-5 rounded shadow-sm text-center">Producten Overzicht</h1>
            <table class="table table-bordered">
                ...
                <?php foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td><?php echo ($product['jaar']); ?></td>
                        <td><?php echo ($product['kleur']); ?></td>
                        <td>
                            <img src="img/<?php echo ($product['afbeelding']); ?>" alt="Afbeelding" style="width: 50px; height: 50px;">
                        </td>
                        <td><?php echo ($product['beschrijving']); ?></td>
                        <td>€ <?php echo number_format($product['prijs'], 2, ',', '.'); ?></td> <!-- Formatteer de prijs -->
                        <td><?php echo ($product['merk_id']); ?></td>
                        <td><?php echo ($product['stock']); ?></td>
                        <td>
                            <a href="product_edit.php?product_id=<?php echo ($product['id']); ?>" class="btn btn-primary btn-sm">Bewerken</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
